For Seamus and Leo:
    ...
    - Everytime you pip install in the venv, afterwards, run "pip freeze > requirements.txt"
      to sync installed files across computers, and push requirements.txt to the repo